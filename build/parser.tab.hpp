...
/**
 ** \file build/parser.tab.hpp
 ** Define the witness::parser class.
 */
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_SERVICE = 9,                           // SERVICE
        S_ACTION = 10,                           // ACTION
        S_SUBJECT = 11,                          // SUBJECT
        S_AUTHORITY = 12,                        // AUTHORITY
        S_TIME = 13,                             // TIME
        S_ASSET = 14,                            // ASSET
        S_CLAUSE = 15,                           // CLAUSE
        S_AND = 16,                              // AND
        ...
        S_statement = 27,                        // statement
        S_type_keyword = 28,                     // type_keyword
        S_type_definition = 29,                  // type_definition
        S_asset_definition = 30,                 // asset_definition
        S_clause_definition = 31,                // clause_definition
        S_expression = 32,                       // expression
        S_function_call = 33,                    // function_call
        S_opt_expression_list = 34,              // opt_expression_list
        S_identifier_expr = 35,                  // identifier_expr
        S_expression_list = 36                   // expression_list
      };
    };
...
switch (yykind)
    ...
    Parser (witness::Driver& driver_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::SERVICE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::SERVICE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_SUBJECT (location_type l)
      {
        return symbol_type (token::SUBJECT, std::move (l));
      }
#else
      static
      symbol_type
      make_SUBJECT (const location_type& l)
      {
        return symbol_type (token::SUBJECT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_AUTHORITY (location_type l)
      {
        return symbol_type (token::AUTHORITY, std::move (l));
      }
#else
      static
      symbol_type
      make_AUTHORITY (const location_type& l)
      {
        return symbol_type (token::AUTHORITY, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ASSET (location_type l)
      {
        return symbol_type (token::ASSET, std::move (l));
      }
#else
      static
      symbol_type
      make_ASSET (const location_type& l)
      {
        return symbol_type (token::ASSET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLAUSE (location_type l)
      {
        return symbol_type (token::CLAUSE, std::move (l));
      }
#else
      static
      symbol_type
      make_CLAUSE (const location_type& l)
      {
        return symbol_type (token::CLAUSE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_EQUIV (location_type l)
      {
        return symbol_type (token::EQUIV, std::move (l));
      }
#else
      static
      symbol_type
      make_EQUIV (const location_type& l)
      {
        return symbol_type (token::EQUIV, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 1820 "build/parser.tab.hpp"
